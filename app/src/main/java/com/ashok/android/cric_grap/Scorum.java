...
public class Scorum extends AppCompatActivity implements OnItemSelectedListener {
    ...
    protected EditText edtscore1, edtscore2, edtscore3, edtscore4, edtscore5, edtscore6;
                ...
                if(TextUtils.isEmpty(scr1)||TextUtils.isEmpty(scr2)||TextUtils.isEmpty(scr3)||TextUtils.isEmpty(scr4)||TextUtils.isEmpty(scr5)||TextUtils.isEmpty(scr6)){
                    ...
                    setPositiveButton("Proceed", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if(TextUtils.isEmpty(scr1))edtscore1.setError("Empty");
                            if(TextUtils.isEmpty(scr2))edtscore2.setError("Empty");
                            if(TextUtils.isEmpty(scr3))edtscore3.setError("Empty");
                            if(TextUtils.isEmpty(scr4))edtscore4.setError("Empty");
                            if(TextUtils.isEmpty(scr5))edtscore5.setError("Empty");
                            if(TextUtils.isEmpty(scr6))edtscore6.setError("Empty");
    ...
    public void CAScascade(Spinner spinner,EditText text, String[] ret){
        text.setText(ret[1]);
    ...
    public void setData() {
        ...
        scr1 = edtscore1.getText().toString();

        Log.e("score",edtscore1.getText().toString());
        scr2 = edtscore2.getText().toString();
        scr3 = edtscore3.getText().toString();
        scr4 = edtscore4.getText().toString();
        scr5 = edtscore5.getText().toString();
        scr6 = edtscore6.getText().toString();
    ...
    public void calcOver(String n) {
        ...
        for (double k = 1.1f; k <= DashBoard.over_count + 1; k += 0.1f) {
    ...
    public void init() {
        ...
        edtscore1 = (EditText) findViewById(R.id.edtscore1);
        edtscore2 = (EditText) findViewById(R.id.edtscore2);
        edtscore3 = (EditText) findViewById(R.id.edtscore3);
        edtscore4 = (EditText) findViewById(R.id.edtscore4);
        edtscore5 = (EditText) findViewById(R.id.edtscore5);
        edtscore6 = (EditText) findViewById(R.id.edtscore6);
        ...
        if (id == R.id.extra) {
            try {
                ...
                enter.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        String extra_ball = ext_ball.getText().toString();
                        String extra_score = ext_score.getText().toString();
                        String extra_spinner = spin.getSelectedItem().toString();
                        ...
                        if (!TextUtils.isEmpty(extra_ball) && !TextUtils.isEmpty(extra_score)&&!TextUtils.isEmpty(extra_spinner)) {
                            ...
                            try{
                                ...
                                if(result>0){
                                    ...
                                    Toast.makeText(Scorum.this, "Score Already Exist", Toast.LENGTH_SHORT).show();
                                }else{
